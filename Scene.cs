...
namespace RayTracer
{
    ...
    internal class Scene
    {
        ...
        internal Scene()
        {
            ...
            primitives.Add(new Sphere(new Vector3(0, -1, 2), 1f, new Vector3(1, 0, 0), new Vector3(0.8f, 0.8f, 0.8f)));
            lights.Add(new Light(new Vector3(0, 5, 2), new Vector3(10, 10, 10)));
        }
