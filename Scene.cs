...
namespace RayTracer
{
    ...
    internal class Scene
    {
        ...
        internal Scene()
        {
            ...
            primitives.Add(new Sphere(new Vector3(0, 0, 4), 1f, new Vector3(1, 0, 0), new Vector3(0.8f, 0.8f, 0.8f), 0, Primitive.Materials.diamond));
            primitives.Add(new Sphere(new Vector3(2.5f, 0, 4), 1f, new Vector3(0, 1, 0), new Vector3(0.8f, 0.8f, 0.8f), 0, Primitive.Materials.diamond));
            primitives.Add(new Sphere(new Vector3(0, 2.5f, 4), 1f, new Vector3(0, 0, 1), new Vector3(0.8f, 0.8f, 0.8f), 0, Primitive.Materials.diamond));
            ...
            lights.Add(new Light(new Vector3(0, 0, 8), new Vector3(5, 5, 5)));
