...
namespace RayTracer
{
    ...
    internal class Scene
    {
        ...
        internal Scene()
        {
            ...
            primitives.Add(new Sphere(new Vector3(0, 0, 4), 0.5f, new Vector3(1, 1, 1), new Vector3(0.8f, 0.8f, 0.8f), 1));
            ...
            lights.Add(new Light(new Vector3(0, 0, 8), new Vector3(100, 100, 100)));
        }
