...
namespace RayTracer
{
    ...
    internal class Raytracer
    {
        ...
        internal Vector3 Trace(Ray ray, Scene scene, int x = 0, int y = 0) //Might Move the things from scene into raytracer for easier code but isn't easier yet so wip
        {
